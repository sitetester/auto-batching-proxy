...
pub struct AppConfig {
    ...
    /// Very small value will cause unnecessary CPU high load, higher value will cause poor API response
    pub batch_check_interval_ms: u64,

    /// Only intended to be used during development. Check tests how such info is used there.
    pub include_batch_info: bool,

    /// Full inference service URL
    pub inference_url: String,

    /// Timeout for inference service
